...
public class ticsingle extends Activity implements View.OnClickListener {
    int turn = 1;
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            ...
            case R.id.rest:
                try {
                    ...
                    in = new Intent(ticsingle.this, c);
            ...
            case R.id.single:
                Class c= null;
                try {
                    c = Class.forName("com.example.myhp.tictacbykanishk.tic");
                } catch (ClassNotFoundException e) {
                    e.printStackTrace();
                }
                in= new Intent(ticsingle.this,c);
        ...
        try {
            c = Class.forName("com.example.myhp.tictacbykanishk.Dialog1");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
        b = new Bundle();
